...
CommonStoringBook _$CommonStoringBookFromJson(Map<String, dynamic> json) {
  return _CommonStoringBook.fromJson(json);
}

/// @nodoc
mixin _$CommonStoringBook {
  ...
  @JsonKey(ignore: true)
  $CommonStoringBookCopyWith<CommonStoringBook> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CommonStoringBookCopyWith<$Res> {
  factory $CommonStoringBookCopyWith(
          CommonStoringBook value, $Res Function(CommonStoringBook) then) =
      _$CommonStoringBookCopyWithImpl<$Res, CommonStoringBook>;
  @useResult
  $Res call(
      {String? isbn,
      String? title,
...
/// @nodoc
class _$CommonStoringBookCopyWithImpl<$Res, $Val extends CommonStoringBook>
    implements $CommonStoringBookCopyWith<$Res> {
  _$CommonStoringBookCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CommonStoringBookImplCopyWith<$Res>
    implements $CommonStoringBookCopyWith<$Res> {
  factory _$$CommonStoringBookImplCopyWith(_$CommonStoringBookImpl value,
          $Res Function(_$CommonStoringBookImpl) then) =
      __$$CommonStoringBookImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? isbn,
...
/// @nodoc
class __$$CommonStoringBookImplCopyWithImpl<$Res>
    extends _$CommonStoringBookCopyWithImpl<$Res, _$CommonStoringBookImpl>
    implements _$$CommonStoringBookImplCopyWith<$Res> {
  __$$CommonStoringBookImplCopyWithImpl(_$CommonStoringBookImpl _value,
      $Res Function(_$CommonStoringBookImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$CommonStoringBookImpl implements _CommonStoringBook {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CommonStoringBookImpl &&
  ...
  _$$CommonStoringBookImplCopyWith<_$CommonStoringBookImpl> get copyWith =>
      __$$CommonStoringBookImplCopyWithImpl<_$CommonStoringBookImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CommonStoringBookImplToJson(
      this,
    );
  }
}
